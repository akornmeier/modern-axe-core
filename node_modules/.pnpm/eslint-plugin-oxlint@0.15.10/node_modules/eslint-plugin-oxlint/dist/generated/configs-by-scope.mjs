import { eslintRules, importRules, jestRules, jsdocRules, jsxA11yRules, nextjsRules, nodeRules, promiseRules, reactRules, reactHooksRules, reactPerfRules, typescriptRules, unicornRules, vitestRules } from "./rules-by-scope.mjs";
const eslintConfig = {
  name: "oxlint/eslint",
  rules: eslintRules
};
